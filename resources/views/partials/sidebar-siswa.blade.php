...
<aside id="sidebar"
    ...
    <nav class="space-y-2">
        ...
        <a href="{{ route('siswa.announcements.index') }}" 
            class="flex items-center gap-2 px-3 py-2 rounded-lg {{ request()->is('siswa/announcements*') ? 'border border-blue-500 bg-blue-50 text-blue-600 font-semibold' : 'hover:bg-gray-100' }}">
